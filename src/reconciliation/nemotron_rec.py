...
class NemotronReconciler:
    """
    NVIDIA Nemotron reconciler using HuggingFace's AutoModelForCausalLM.
    Integrates NVIDIA's instruction-following models for zero-shot schema mapping.
    """
    ...
    def _infer(self, original: Dict, drifted: Dict) -> Dict[str, str]:
        ...
        messages = [{
            ...
            "content": (
                ...
                f"Output ONLY a valid JSON object matching: {{\"original\": \"drifted\"}}"
            )
        }]
