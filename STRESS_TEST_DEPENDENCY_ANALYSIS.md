...
**Analyzed Scripts:**
1. `tools/cadillac_gpu_stress_test.py`
2. `tools/cadillac_stress_test.py`
...
✅ **USED:**
- `src/circuit_breaker.py` (used by cadillac_gpu_stress_test.py, cadillac_stress_test.py)
- `src/local_persistence.py` (used by cadillac_gpu_stress_test.py, cadillac_stress_test.py)
- `src/geo_fence.py` (used by cadillac_gpu_stress_test.py, cadillac_stress_test.py)
- `src/audit_log.py` (used by cadillac_gpu_stress_test.py, cadillac_stress_test.py, and imported by geo_fence.py)
- `src/middleware/tracing.py` (used by cadillac_gpu_stress_test.py, cadillac_stress_test.py)
- `src/slo.py` (used by cadillac_gpu_stress_test.py, cadillac_stress_test.py)
...
✅ **STRESS TEST SCRIPTS:**
- `tools/cadillac_gpu_stress_test.py` (stress test #1)
- `tools/cadillac_stress_test.py` (stress test #2)
...
8. `tools/cadillac_gpu_stress_test.py` (stress test)
9. `tools/cadillac_stress_test.py` (stress test)
...
1. **Both Cadillac stress tests use identical dependencies** - they share the same 6 src/ files.
...
4. **src/geo_fence.py is the only file with a transitive dependency** - it imports src/audit_log.py, which is already directly imported by both Cadillac stress tests.
