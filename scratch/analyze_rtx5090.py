...
def main():
    print("================================================================================")
    print("ANALYZING RTX 5090 TELEMETRY STREAMS...")
    print("================================================================================")
    
    files = sorted(glob.glob('results/RTX_5090*/*.jsonl'))
    if not files:
        print("No RTX 5090 telemetry stream files found!")
        return
    ...
    df.to_csv('results/rtx5090_processed_results.csv', index=False)
    print(f"\nSaved master run csv to results/rtx5090_processed_results.csv")
    ...
    latency_summary.to_csv('results/rtx5090_latency_vs_method.csv', index=False)
    
    print("Compiling granular drift type accuracy for RTX 5090...")
    drift_records = []
    for fp in files:
        with open(fp, 'r', encoding='utf-8') as f:
            for line in f:
    ...
    drift_accuracy.to_csv('results/rtx5090_accuracy_vs_drift.csv', index=False)
    
    print("\n================================================================================")
    print(" RTX 5090 EMPIRICAL SUMMARY")
    print("================================================================================")
    ...
    report_md = f"""# RTX 5090 Empirical Benchmark Assessment
...
"""
    ...
    with open('results/rtx5090_assessment_report.md', 'w') as rf:
        rf.write(report_md)
        
    print("\nSaved markdown report to results/rtx5090_assessment_report.md")
