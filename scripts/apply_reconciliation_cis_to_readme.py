...
print("Updating README.md: dropping Hosseini resilience and adding 95% CIs for all reconciliation figures...")

readme_path = "README.md"
content = open(readme_path).read()

# 1. Update Reconciliation Baselines Table (replace Hosseini column with 95% Confidence Interval)
old_rec_table = """| Reconciler Baseline | Acceleration / Hardware Target | GPU Allocation | Mean Reconciliation Acc. (%) | Hosseini Resilience ($R_{\\text{H}}$) | Measured Latency (ms/packet) | System Throughput (packets/sec) |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: |
...
new_rec_table = """| Reconciler Baseline | Acceleration / Hardware Target | GPU Allocation | Mean Reconciliation Acc. (%) | 95% Confidence Interval | Measured Latency (ms/packet) | System Throughput (packets/sec) |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: |
...
# 2. Update Dedicated Classical Summary Table (remove Hosseini column)
old_classical_table = """| Model / Architecture | Training / Split Protocol | Mean Routing-Selection Acc. (%) | Hosseini Resilience ($R_{\\text{H}}$) | 95% Confidence Interval | Macro F1-Score (%) | LOAO Cross-Val Acc. (%) | Mean Inference Latency (ms) | Derived batch-amortized evaluation rate (pps) |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
...
# 3. Update Router Selection Baselines Table (remove Hosseini column)
old_router_table = """| Router Selection Architecture | Hardware Target | Mean Routing-Selection Acc. (%) | Hosseini Resilience ($R_{\\text{H}}$) | LOAO Cross-Val Acc. (%) | Mean Inference Latency (ms/packet) | Derived batch-amortized evaluation rate (pps) |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: |
...
new_router_table = """| Router Selection Architecture | Hardware Target | Mean Routing-Selection Acc. (%) | LOAO Cross-Val Acc. (%) | Mean Inference Latency (ms/packet) | Derived batch-amortized evaluation rate (pps) |
| :--- | :--- | :---: | :---: | :---: | :---: |
...
# 4. Update End-to-End Routed Stream Reconciliation Table (replace Hosseini column with 95% Confidence Interval)
old_e2e_table = """| Router Architecture | Hardware Target | First-Choice Routing Acc. (%) | Routed End-to-End Reconciliation Acc. (%) | Hosseini Resilience ($R_{\\text{H}}$) | Mean Inference Latency (ms) | Notes |
| :--- | :--- | :---: | :---: | :---: | :---: | :--- |
...
new_e2e_table = """| Router Architecture | Hardware Target | First-Choice Routing Acc. (%) | Routed End-to-End Reconciliation Acc. (%) | 95% Confidence Interval | Mean Inference Latency (ms) | Notes |
| :--- | :--- | :---: | :---: | :---: | :---: | :--- |
...
print("SUCCESS: Updated README.md with 95% CIs for all reconciliation figures (Hosseini removed)!")
