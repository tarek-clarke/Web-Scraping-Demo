...
ORACLE="${ORACLE:-data/training/router_oracle_22500_v4_${HARDWARE_TAG}.jsonl}"
ORACLE_STEM="${ORACLE%.jsonl}"
CANDIDATES="data/training/qpu_router_multistart_v4_${HARDWARE_TAG}"
MODEL="configs/quantum_router_v4_${HARDWARE_TAG}.json"
