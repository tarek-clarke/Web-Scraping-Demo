...
def main():
    ...
    if not has_compatible_torch:
        ...
        if has_nvidia and is_linux:
            ...
            run_cmd(f"{sys.executable} -m pip install --default-timeout=1000 --retries 10 --ignore-installed --pre torch --index-url https://download.pytorch.org/whl/nightly/cu128")
