...
def main():
    ...
    try:
        ...
        manifest = {
            ...
            "total_energy_joules": float(energy_metrics.get("total_joules", 0.0)),
            "gpu_total_energy_joules": float(energy_metrics.get("gpu_energy_draw_joules", 0.0)),
            "cpu_total_energy_joules": float(energy_metrics.get("cpu_energy_draw_joules", 0.0)),
